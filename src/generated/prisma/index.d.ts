...
export namespace Prisma {
  ...
  */
  ...
  interface userFieldRefs {
    ...
    readonly discordDiscriminator: FieldRef<"user", 'String'>
  ...
  export type serverOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "value" | "ip" | "port" | "connIp" | "rconPort" | "rconPassword" | "serverVersion" | "serverSoftware" | "createdAt" | "updatedAt", ExtArgs["result"]["server"]>
  ...
  interface serverFieldRefs {
    ...
    readonly value: FieldRef<"server", 'String'>
    readonly ip: FieldRef<"server", 'String'>
    readonly port: FieldRef<"server", 'Int'>
    readonly connIp: FieldRef<"server", 'String'>
    readonly rconPort: FieldRef<"server", 'Int'>
    readonly rconPassword: FieldRef<"server", 'String'>
    readonly serverVersion: FieldRef<"server", 'String'>
    readonly serverSoftware: FieldRef<"server", 'String'>
  ...
  export type userWhereInput = {
    ...
    discordUserId?: StringFilter<"user"> | string
  ...
  export type userScalarWhereWithAggregatesInput = {
    ...
    discordUserId?: StringWithAggregatesFilter<"user"> | string
    discordUsername?: StringWithAggregatesFilter<"user"> | string
    discordDiscriminator?: StringWithAggregatesFilter<"user"> | string
  ...
  export type serverWhereInput = {
    ...
    value?: StringFilter<"server"> | string
    ip?: StringFilter<"server"> | string
    port?: IntFilter<"server"> | number
    connIp?: StringFilter<"server"> | string
    rconPort?: IntFilter<"server"> | number
    rconPassword?: StringFilter<"server"> | string
    serverVersion?: StringFilter<"server"> | string
    serverSoftware?: StringFilter<"server"> | string
  ...
  export type serverScalarWhereWithAggregatesInput = {
    ...
    value?: StringWithAggregatesFilter<"server"> | string
    ip?: StringWithAggregatesFilter<"server"> | string
    port?: IntWithAggregatesFilter<"server"> | number
    connIp?: StringWithAggregatesFilter<"server"> | string
    rconPort?: IntWithAggregatesFilter<"server"> | number
    rconPassword?: StringWithAggregatesFilter<"server"> | string
    serverVersion?: StringWithAggregatesFilter<"server"> | string
    serverSoftware?: StringWithAggregatesFilter<"server"> | string
  ...
  export type serverUpdateInput = {
    ...
    connIp?: StringFieldUpdateOperationsInput | string
    ...
    serverSoftware?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
